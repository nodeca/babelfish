...
BabelFish.prototype.setFallback = function setFallback(locale) {
  var self = this, fallbacks = this._fallbacks[locale] = [];
...
/**
 *  BabelFish#getFallback(locale) -> Array
 *
 *  Returns list of fallbacks for `locale`.
 *
 *  ##### Example
 *
 *      var fallbacks = i18n.getFallback('ua');
 **/
BabelFish.prototype.getFallback = function getFallback(locale) {
