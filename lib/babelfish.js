...
BabelFish.prototype.addPhrase  = function addPhrase(locale, scope, value) {
  ...
  // process inner scope
  chunks.forEach(function (scope_key) {
  ...
  // compile string and determine type of result
  c_value = compile(value);
  c_type  = ('function' === typeof c_value) ? 'function' : 'string';
