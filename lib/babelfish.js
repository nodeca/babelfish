...
function recompile(self, locale) {
  var fallbacks = getFallbacks(self, locale);

  function dig(obj) {
    Common.each(obj, function (data, key) {
      // dig deeper
      if ('object' === data.type) {
        dig(data.value);
        return;
  ...
  dig(getLocaleStorage(self, locale));
}
...
function BabelFish(defaultLocale) {
   ...
   **/
  Object.defineProperty(this, 'defaultLocale', {value: defaultLocale || 'en'});
