...
function isObject(obj) {
  return !isArray(obj) && !isFunction(obj) && (obj === Object(obj));
}
...
/** chainable
 *  BabelFish#addPhrase(locale, phrase, translation, [asis]) -> BabelFish
 *  - locale (String): Locale of translation
 *  - phrase (String|Null): Phrase ID, e.g. `apps.forum`
 *  - translation (String|Object|Array|Number): Translation or an object with
 *    nested phrases, or a pure object.
 *  - asis (Boolean): Optional. True if translation should be used as Object
 *    (without compilation). Note, only JSON stringifyable objects should be used.
 *    If you pass `Array`, `Number` or `Boolean`, `asis` can be skipped.
 *
 *  ##### Errors
 *
 ...
 **/
BabelFish.prototype.addPhrase = function _addPhrase(locale, phrase, translation, asis) {
  var self = this, _t;

  if (isObject(translation) && !asis) {
    // recursive recursion
  ...
  if (isArray(translation) || isNumber(translation) || isBoolean(translation) || asis) {
