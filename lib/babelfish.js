...
/**
 *  BabelFish#hasTranslation(locale, scope) -> Boolean
 *  - locale (String): Locale of translation
 *  - scope (String): Full phrase path, e.g. `app.forums.replies_count`
 *
 *  Returns whenever or not there's a translation of a `scope`.
 **/
BabelFish.prototype.hasTranslation = function hasTranslation(locale, scope) {
  var translator  = this.getCompiledData(locale, scope);
