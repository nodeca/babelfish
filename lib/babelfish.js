...
/** chainable
 *  BabelFish#addPhrase(locale, phrase, value) -> BabelFish
 *  - locale (String): Locale of translation
 *  - phrase (String|Null): Phrase ID, e.g. `apps.forum`
 *  - value (String|Object): Value or an object with nested phrases.
 *
 *  ##### Errors
 *
 ...
 **/
BabelFish.prototype.addPhrase = function addPhrase(locale, phrase, value) {
  var self = this, t = typeof value;
  ...
  if ('string' !== t && 'object' !== t && value !== (value || '').toString()) {
    ...
    Underscore.each(value, function (value, key) {
      self.addPhrase(locale, phrase + '.' + key, value);
    });
    return;
  }
...
/**
 *  BabelFish#hasTranslation(locale, phrase) -> Boolean
 *  - locale (String): Locale of translation
 *  - phrase (String): Phrase ID, e.g. `app.forums.replies_count`
 *
