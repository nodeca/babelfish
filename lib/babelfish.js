 ...
 *  - asis (Boolean): Optional. True if translation should be used as Object (without
 *    compilation). Note, only JSON stringifyable objects should be used. If you pass
 *    Array, `asis` can be skipped.
 *
 *  ##### Errors
 *
...
BabelFish.prototype.addPhrase = function _addPhrase(locale, phrase, translation, asis) {
  ...
  if (!isString(translation) && !isArray(translation) && !isObject(translation)) {
    throw new TypeError('Invalid translation. [String|Object|Array] expected');
  }

  if (isArray(translation) || asis) {
...
BabelFish.prototype.hasPhrase = function _hasPhrase(locale, phrase) {
  var translator  = this.getCompiledData(locale, phrase);
  return 0 === translator.e || 1 === translator.e || 2 === translator.e;
};
