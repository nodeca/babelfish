/*global window*/
var BabelFish = window.BabelFish = (function (_) {
  "use strict";

  var ctx = {}, PLURALIZERS = {};

  ctx.flattenParams = function (obj) {
    var params = {};

    _.each(obj || {}, function (val, key) {
      if ('object' === typeof val) {
        _.each(ctx.flattenParams(val), function (sub_val, sub_key) {
  ...
  ctx.pluralize = function (lang, count, forms) {
    var idx;
